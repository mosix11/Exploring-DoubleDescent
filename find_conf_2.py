import collections
import math
# statistics.stdev is typically available. If not, _calculate_stdev can be used.
import statistics 
...
def get_network_configurations_v3(
    input_dim: int, 
    output_dim: int, 
...
configurations_v3 = get_network_configurations_v3(
