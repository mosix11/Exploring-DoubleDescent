...
class SVHN(BaseClassificationDataset):
    ...
    def load_train_set(self):
        return datasets.SVHN(root=self.dataset_dir, split="train", transform=self.get_transforms(train=True), download=True)
    ...
    def load_test_set(self):
        return datasets.SVHN(root=self.dataset_dir, split="test", transform=self.get_transforms(train=False), download=True)
