# https://github.com/AntoAndGar/task_singular_vectors/blob/main/src/datasets/templates.py
cars_template = [
...
dataset_to_template = {
    ...
    "pcam": pcam_template,
    "oxfordpet": oxfordpets_template,
    "renderedsst2": sst2_template,
    "emnist": emnist_template,
    "fashion_mnist": fashionmnist_template,
    "kmnist": kmnist_template,
}


def get_clip_templates(dataset_name):
